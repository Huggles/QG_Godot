...
public partial class StatusMackenzieKingDraftstheNationalResourcesMobilizationAct : StatusCardLogic, IVPModifier
{
    public virtual VPEntry AddVictoryPoints()
    {
        ...
        return new VPEntry(score, $"{score} victory points for a navy in {CountryState.ForEnum(Country.NorthAtlantic).Label} and army in {CountryState.ForEnum(Country.Canada).Label}.");
    }
