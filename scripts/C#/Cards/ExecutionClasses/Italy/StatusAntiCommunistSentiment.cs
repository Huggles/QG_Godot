...
public partial class StatusAntiCommunistSentiment : StatusCardLogic, IStatusVictoryPoints
{
    public virtual VPEntry AddVictoryPoints()
    {
        ...
        return new VPEntry(score, $"{score} victory points for {FactionState.ForEnum(Faction).FactionData.FactionAdjactiveLabel} armies in {CountryState.ForEnum(countries[0]).Label} and {CountryState.ForEnum(countries[1]).Label}.");
    }
