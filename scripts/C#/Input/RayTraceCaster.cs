...
public partial class RayTraceCaster : Object
{
    ...
    private uint spriteLayers = 0x000F;
    ...
    private Godot.Collections.Array<Godot.Collections.Dictionary> ShootRays()
    {
        ...
        while (true)
        {
            var query = PhysicsRayQueryParameters3D.Create(from, to, spriteLayers, collidersToIgnore);
